    ...
    if($numero2 != 0 ){
        ...
        while ($registro = mysqli_fetch_assoc($query2)){ 
            ...
            if($registro['tipo'] == 'biometria'){
                $img = '<img title="Biometria" class="manImg" src="http://localhost/passctrl/img/icon/Fingerprint Scan-50.png"></img>';
            }else if($registro['tipo'] == 'rfid'){
                $img = '<img title="RFID" class="manImg" src="http://localhost/passctrl/img/icon/RFID Tag Filled-50.png"></img>';
           }else if($registro['tipo'] == 'nfc'){
                $img = '<img title="NFC" class="manImg" src="http://localhost/passctrl/img/icon/NFC N-52.png"></img>';
            }else{
                $img = 'none';
            }
            echo'
