<?php
    ...
    while ($registro = mysqli_fetch_assoc($query2)){ 
        ...
        $BIO = '<img class="manImg" src="http://localhost/passctrl/img/icon/Fingerprint Scan-50.png"></img>';
        $RF = '<img class="manImg" src="http://localhost/passctrl/img/icon/RFID Tag Filled-50.png"></img>';
        $NF = '<img class="manImg" src="http://localhost/passctrl/img/icon/NFC N-52.png"></img>';
        ...
        }//<div id="img_user"><img src="http://localhost/passctrl/img/usuarios/anonimo.jpg"></div>
        if($user == "ON"){//<div id="img_user"><img src="http://localhost/passctrl/img/usuarios/plataf.jpg"></div>
        echo '  
