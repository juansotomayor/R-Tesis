...
if( isset($_SESSION['ingreso']) || isset($_COOKIE['nueva'])){
	...
	$URL="http://localhost/passctrl/modulo";
...
<head>
	...
	<link rel="stylesheet" href="http://localhost/passctrl/css/login.css" type="text/css" />
			...
			xhr.onreadystatechange = function() {
                if (xhr.readyState == 4 && xhr.status == 200) {
                  ...
                  if(r == 4){
                    ...
                    setTimeout("location.href = 'http://localhost/passctrl/modulo';",1000);
                  }
                }
      };
			xhr.send(fd);
...
<body onload="myFunction()">
    <section>
        <div class="mobile-screen">
          ...
          <div class="logo">
            <img src="http://localhost/passctrl/img/ctrllpas.png" />
          </div>
