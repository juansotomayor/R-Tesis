...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/passctrl/css/tables.css" type="text/css" />
	<link rel="stylesheet" href="http://localhost/passctrl/css/input.css" type="text/css" />
  <link rel="stylesheet" href="http://localhost/passctrl/css/style.css" type="text/css" />
  <link rel="stylesheet" href="http://localhost/comercializadora/css/font-awesome.min.css">
  <link rel="stylesheet" href="http://localhost/passctrl/css/drop.css" type="text/css" />
  <link rel="stylesheet" href="http://localhost/passctrl/css/estadisticas.css" type="text/css" />

  <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-T8Gy5hrqNKT+hzMclPo118YTQO6cYprQmhrYwIiQ/3axmI1hQomh7Ud2hPOy8SP1" crossorigin="anonymous">
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js" integrity="sha384-0mSbJDEHialfmuBBQP6A4Qrprq5OVfW37PRR3j5ELqxss1yVqOtnepnHVP9aJ7xS" crossorigin="anonymous"></script>
  <script src="http://code.jquery.com/jquery-latest.js"></script>
	<script src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.2.2/jquery.min.js'></script>
  <script src="http://localhost/passctrl/js/modernizr.js"></script>
  <script src="http://localhost/passctrl/js/inputfile.js"></script>
  <script src="http://localhost/passctrl/js/efectos.js"></script>
  <script src="http://localhost/passctrl/js/tooltip.js"></script>
  <link rel="stylesheet" href="http://localhost/passctrl/js/tooltip.css">
  <script>
  function AddUser()
	{
    var fd = new FormData();
...
<body class="">
  ...
  <div class="container">
    <div class="breadcrumbs">
      <img style="top: 7px; left: 80px; height: 45px; z-index: 2; position: absolute;" src="http://localhost/passctrl/img/ctrllpas.png">      
      <ul class="social">
        <?php
            include($_SERVER['DOCUMENT_ROOT']."/passctrl/modulo/sesion.php");
        ?>
      </ul>
    </div>
    ...
    <ul class="tl-menu">
      <li><a href="#">Logo</a></li>
      <li class="tl-current"><a title="Ver modulos" href="http://localhost/passctrl/modulo/" class="entypo-shareable" id="navItem1">Option 1</a></li>
    ...
    <div  class="main"> 
        <div class="img_user2" id="img_user2">
            <img src="http://localhost/passctrl/img/usuarios/anonimo.jpg">
        </div>
        ...
        <table class="add_user">
            <tbody>
                ...
                <tr >
                    <td >RUT:</td>
                    <td ><input id="form3" title="Ingrese el RUT sin puntos ni digito verificador" class="input_text" type="text" ></td>
                    <td >Sexo:</td>
                    <td >
        ...
        <table class="datos_acceso">
            <thead>
                <tr>        
                    <th>Módulo</th>
                    <th>Acceso</th>
                    <th><a title="Biometria"><img class="manImg" src="http://localhost/passctrl/img/icon/Fingerprint Scan-50.png"></img></a></th>
                    <th><a title="RFID"><img class="manImg" src="http://localhost/passctrl/img/icon/RFID Tag Filled-50.png"></img></a></th>
                    <th><a title="NFC"><img class="manImg" src="http://localhost/passctrl/img/icon/NFC N-52.png"></img></a></th>
                </tr>
            </thead>
            <tbody>
                <tr>
    ...
    <nav class="slider-menu slider-menu-vertical slider-menu-left" id="slider-menu-s1">
      <h3>MODULO</h3>
      <a href="http://localhost/passctrl/modulo/usuarios.php" ><i class="fa fa-users" aria-hidden="true"></i>&nbsp;<p>Usuarios</p></a>
      <a href="http://localhost/passctrl/modulo/agregar_usuario.php"><i  class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;<p>Agregar Usuario</p></a>
      <a href="#"></a>
      <a href="#"></a>
      <a href="#"></a>
      <a href="#"></a>
