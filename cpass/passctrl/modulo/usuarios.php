  ...
  <div class="container">
    ...
    <div id="main_usuarios" class="main">       
      ...
      if($numero2 != 0 ){
        ...
        while ($registro = mysqli_fetch_assoc($query2)){ 
          ...
          $img = $registro['imagen'];          
            ...
            <tr id="'.$Q.'" class="tr" onclick="ventanaMenu(this.id, '.$id.')" >  
              ...
              if($img){
                  echo'
                  <img src="http://localhost/passctrl/modulo/img/usuarios/'.$img.'">
                  ';
              }else{
                  echo'
        ...
        echo'
              <script src="http://localhost/passctrl/js/inputEfect.js"></script>
    ...
    <nav class="slider-menu slider-menu-vertical slider-menu-left" id="slider-menu-s1">
      ...
      <a href="http://localhost/passctrl/modulo/agregar_usuario.php"><i  class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;<p>Agregar Usuario</p></a>      <a href="#">Item 3</a>
      <a href="#">Item 4</a>
      <a href="#">Item 5</a>
      <a href="#">Item 6</a>
      <a href="#">Item 7</a>
